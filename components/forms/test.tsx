...
const RegisterForm = ({ user }: { user: User }) => {
  ...
  async function onSubmit(values: z.infer<typeof PatientFormValidation>) {
   ...
   console.log(values)
    ...
    let formData = new FormData(); // Initialize FormData outside the condition
    ...
    if (
      ...
      // Append the file directly to FormData (no need to create a Blob)
      formData.append("file", file, file.name); // Use "file" as the key and include the file name
    }
    try {
      const patientData = {
        ...values,
